...
//holds a list of information concerning all POJO classes, passed into my Places
//reason for extra functionality is Google API places an extra set of JSON objects within an Array
